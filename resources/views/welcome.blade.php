    ...
    <main>
      ...
      <div id="pelayanan" class="page hidden">
        <div class="card">
          ...
          <p class="small">Pilih layanan yang ingin diajukan. Untuk Pengesahan Penyelenggaraan Pelayanan Kesehatan
            Kerja, pilih opsi Form Lengkap di bawah.</p>

          <select id="pilihanLayanan" onchange="tampilForm()">
            <option value="">-- Pilih Layanan --</option>
            <option value="pelkes_full">Pengesahan Penyelenggaraan Pelayanan Kesehatan Kerja di Perusahaan</option>
            ...
            <fieldset class="no-border-padding">
              ...
              <div class="grid">
                <div>
                  ...
                  <div class="muted">Nama, alamat email, dan foto terkait akun akan direkam saat upload file (sesuai
                ...
                <div>
                  ...
                  <input id="companySector" type="text" required placeholder="Contoh: Manufaktur / Konstruksi">
                </div>
                <div>
              ...
              <div>
                ...
                <div class="row">
                  <label class="radio-group"><input type="radio" name="jenisPelaporan" value="kk" checked> Pelaporan
                    Kecelakaan Kerja (KK)</label>
                  <label class="radio-group"><input type="radio" name="jenisPelaporan" value="pak"> Pelaporan Penyakit
              ...
              <div id="sectionKK" class="kk-section">
                ...
                <p class="muted">Pengisian berdasarkan SK Dirjen Kep.84/BW/1998. Silakan unggah Form Laporan KK1/PAK1
                  (PDF, maks 1 MB).</p>
                <div class="grid">
                  <div>
                  ...
                  <div>
                    ...
                    <input id="victimBirthplace" type="text" placeholder="Tempat, dd-mm-yyyy" required>
                  </div>
                  <div>
                  ...
                  <div class="full">
                    <label for="accidentDesc">Uraian Kejadian Kecelakaan (Kronologis Lengkap)</label>
                    <textarea id="accidentDesc" required></textarea>
                  </div>

                  <div>
                    <label for="accidentEffect">Akibat Kecelakaan</label>
                    <input id="accidentEffect" type="text" required placeholder="Contoh: Luka, Cacat, Meninggal">
                  </div>

                  <div class="full">
                    <label>Bagian Tubuh Yang Cedera (boleh pilih lebih dari satu)</label>
                    <div class="row">
                      <label class="checkbox"><input type="checkbox" name="bodyPart" value="A7"> Kepala (A7)</label>
                      <label class="checkbox"><input type="checkbox" name="bodyPart" value="A8"> Mata (A8)</label>
                      <label class="checkbox"><input type="checkbox" name="bodyPart" value="A9"> Telinga (A9)</label>
                      <label class="checkbox"><input type="checkbox" name="bodyPart" value="A10"> Badan (A10)</label>
                      <label class="checkbox"><input type="checkbox" name="bodyPart" value="A11"> Lengan (A11)</label>
                      <label class="checkbox"><input type="checkbox" name="bodyPart" value="A12"> Tangan (A12)</label>
                      <label class="checkbox"><input type="checkbox" name="bodyPart" value="A13"> Jari Tangan
                        (A13)</label>
                      <label class="checkbox"><input type="checkbox" name="bodyPart" value="A14"> Paha (A14)</label>
                      <label class="checkbox"><input type="checkbox" name="bodyPart" value="A15"> Kaki (A15)</label>
                      <label class="checkbox"><input type="checkbox" name="bodyPart" value="A16"> Jari Kaki / Organ
                        Dalam (A16)</label>
                    </div>
                  </div>
                  ...
                  <div class="full">
                    ...
                    <div class="row">
                      <label class="checkbox"><input type="checkbox" name="source" value="B1"> Mesin (B1)</label>
                      <label class="checkbox"><input type="checkbox" name="source" value="B2"> Penggerak Mula / Pompa
                        (B2)</label>
                      <label class="checkbox"><input type="checkbox" name="source" value="B10"> Peralatan Listrik
                        (B10)</label>
                      <label class="checkbox"><input type="checkbox" name="source" value="B11"> Bahan Kimia
                        (B11)</label>
                      <label class="checkbox"><input type="checkbox" name="source" value="B14"> Faktor Lingkungan
                        (B14)</label>
                      <label class="checkbox"><input type="checkbox" name="source" value="otherSource"> Yang
                        lain</label>
                      <input id="otherSourceText" class="hidden" placeholder="Sebutkan sumber lain" />
                    </div>
                  </div>
                  ...
                  <div class="full">
                    ...
                    <div class="row">
                      <label class="checkbox"><input type="checkbox" name="type" value="C1"> Terbentur (C1)</label>
                      <label class="checkbox"><input type="checkbox" name="type" value="C2"> Terpukul (C2)</label>
                      <label class="checkbox"><input type="checkbox" name="type" value="C3"> Tertangkap (C3)</label>
                      <label class="checkbox"><input type="checkbox" name="type" value="C4"> Jatuh sama level
                        (C4)</label>
                      <label class="checkbox"><input type="checkbox" name="type" value="C5"> Jatuh beda level
                        (C5)</label>
                      <label class="checkbox"><input type="checkbox" name="type" value="C9"> Tersentuh listrik
                        (C9)</label>
                      <label class="checkbox"><input type="checkbox" name="type" value="otherType"> Yang lain</label>
                  ...
                  <div class="full">
                    ...
                    <div class="row">
                      <label class="checkbox"><input type="checkbox" name="condition" value="D1"> Pengamanan tidak
                        sempurna (D1)</label>
                      <label class="checkbox"><input type="checkbox" name="condition" value="D4"> Prosedur tidak aman
                        (D4)</label>
                      <label class="checkbox"><input type="checkbox" name="condition" value="D6"> Ventilasi tidak
                        sempurna (D6)</label>
                      <label class="checkbox"><input type="checkbox" name="condition" value="otherCondition"> Yang
                        lain</label>
                      <input id="otherConditionText" class="hidden" placeholder="Sebutkan kondisi lain" />
                    </div>
                  </div>
                  ...
                  <div class="full">
                    ...
                    <div class="row">
                      <label class="checkbox"><input type="checkbox" name="action" value="E1"> Tanpa wewenang / lupa
                        mengamankan (E1)</label>
                      <label class="checkbox"><input type="checkbox" name="action" value="E4"> Memakai peralatan tidak
                        aman (E4)</label>
                      <label class="checkbox"><input type="checkbox" name="action" value="E9"> Melalaikan APD
                        (E9)</label>
                      <label class="checkbox"><input type="checkbox" name="action" value="otherAction"> Yang
                        lain</label>
                      <input id="otherActionText" class="hidden" placeholder="Sebutkan tindakan lain" />
                    </div>
                  </div>
              ...
              <div class="flex-buttons">
                <button type="button" class="btn" id="previewBtn">Pratinjau & Simpan (Unduh JSON)</button>
        ...
        <div id="form_p2k3" class="card formdata hidden">
          ...
          <p class="small">
            Pelaporan kegiatan P2K3 dan penyelenggaraan pelayanan kesehatan kerja wajib dilakukan setiap 3 (tiga) bulan
          ...
          <form id="form_p2k3_short" novalidate>
            ...
            <input id="p2k3_email" type="email" placeholder="email@example.com" title="Masukkan alamat email" required>
            ...
            <div class="fieldset">
              ...
              <input id="p2k3_sektor" type="text" placeholder="Contoh: Manufaktur / Jasa" title="Sektor perusahaan"
                required>

              <label for="p2k3_pimpinan">Nama Pimpinan Perusahaan <span class="small">*</span></label>
              <input id="p2k3_pimpinan" type="text" placeholder="Nama lengkap pimpinan" title="Nama pimpinan" required>

              <label for="p2k3_jabatan">Jabatan Pimpinan <span class="small">*</span></label>
              <input id="p2k3_jabatan" type="text" placeholder="Contoh: Direktur Utama" title="Jabatan pimpinan"
                required>

              <div class="row">
                <div class="col">
                  <label for="p2k3_wni_laki">Jumlah TK WNI Laki-Laki <span class="small">*</span></label>
                  <input id="p2k3_wni_laki" type="number" min="0" value="0" placeholder="0" title="Angka saja" required>
                </div>
                <div class="col">
                  <label for="p2k3_wni_perempuan">Jumlah TK WNI Perempuan <span class="small">*</span></label>
                  <input id="p2k3_wni_perempuan" type="number" min="0" value="0" placeholder="0" title="Angka saja"
                    required>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col">
                  <label for="p2k3_wna_laki">Jumlah TK WNA Laki-Laki <span class="small">*</span></label>
                  <input id="p2k3_wna_laki" type="number" min="0" value="0" placeholder="0" title="Jika tidak ada isi 0"
                    required>
                </div>
                <div class="col">
                  <label for="p2k3_wna_perempuan">Jumlah TK WNA Perempuan <span class="small">*</span></label>
              ...
              <div class="row">
                <div class="col">
                  ...
                  <input id="p2k3_tahun" type="number" min="2000" max="2100" placeholder="2025" title="Tahun pelaporan"
                    required>
                </div>
                <div class="col">
            ...
            <div id="p2k3_section" class="fieldset hidden">
              ...
              <input id="p2k3_ketua" type="text" placeholder="Nama Ketua P2K3" title="Nama Ketua" required>
              ...
              <input id="p2k3_sekretaris" type="text" placeholder="Nama Sekretaris" title="Nama Sekretaris" required>

              <label for="p2k3_nomorsk">Nomor SK P2K3 <span class="small">*</span></label>
              <input id="p2k3_nomorsk" type="text" placeholder="Nomor SK P2K3" title="Nomor SK P2K3" required>
              ...
              <div>
                <label><input type="checkbox" name="p2k3_ahli_spesialis" value="kebakaran"> Ahli K3
                  Kebakaran</label><br>
                <label><input type="checkbox" name="p2k3_ahli_spesialis" value="kimia"> Ahli K3 Kimia</label><br>
                <label><input type="checkbox" name="p2k3_ahli_spesialis" value="lingkungan"> Ahli K3 Lingkungan
                  Kerja</label><br>
                <label><input type="checkbox" name="p2k3_ahli_spesialis" value="konstruksi"> Ahli K3
                  Konstruksi</label><br>
                <label><input type="checkbox" name="p2k3_ahli_spesialis" value="listrik"> Ahli K3 Listrik</label><br>
                <label><input type="checkbox" name="p2k3_ahli_spesialis" value="lainnya"> Yang lain</label>
                <input id="p2k3_ahli_lain" type="text" placeholder="Keterangan jika ada" title="Keterangan ahli lain">
              </div>
              ...
              <div>
                ...
                <label><input type="checkbox" name="p2k3_eval" value="peralatan"> Peralatan Mesin</label>
                ...
                <label><input type="checkbox" name="p2k3_eval" value="kebakaran"> Pencegahan Kebakaran</label>
                <label><input type="checkbox" name="p2k3_eval" value="lingkungan"> Lingkungan Kerja</label>
              </div>
              ...
              <textarea id="p2k3_hambatan" placeholder="Jelaskan hambatan" title="Hambatan dalam pelaksanaan K3"
                required></textarea>
              ...
              <div>
                <label><input type="checkbox" id="p2k3_selesai" title="Cek jika telah selesai mengisi"> Ya</label>
              </div>

              <label for="p2k3_file_report">Unggah Dokumen Pelaporan P2K3 <span class="small">*</span></label>
              <input id="p2k3_file_report" type="file" accept="application/pdf" title="Upload PDF, maks 10 MB" required>
            ...
            <div id="pelkes_section" class="fieldset hidden">
              ...
              <label for="pelkes_triwulan">Pelaporan Pelayanan Kesehatan Kerja <span class="small">*</span></label>
              ...
              <div>
                <label><input type="radio" name="pelkes_bentuk" value="sendiri" required> Diselenggarakan sendiri oleh
                  Pengurus Perusahaan</label><br>
                <label><input type="radio" name="pelkes_bentuk" value="kerjasama"> Diselenggarakan melalui
                  kerjasama</label><br>
                <label><input type="radio" name="pelkes_bentuk" value="bersama"> Diselenggarakan bersama beberapa
                  perusahaan</label>
              </div>

              <div id="pelkes_sendiri_type" class="small hidden">
                <label>Bentuk Penyelenggaraan (jika sendiri)</label>
                <label><input type="checkbox" name="pelkes_sendiri" value="rs"> Rumah Sakit Perusahaan</label>
                <label><input type="checkbox" name="pelkes_sendiri" value="klinik"> Klinik Perusahaan</label>
              ...
              <div class="row">
                ...
                <div class="col">
                  <label for="pelkes_jumlah_hiperkes">Jumlah Dokter yang memiliki Sertifikat Hiperkes</label>
              ...
              <div>
                <label><input type="checkbox" name="pelkes_sarana" value="ruang_tunggu"> Ruang Tunggu</label>
                <label><input type="checkbox" name="pelkes_sarana" value="ruang_periksa"> Ruang Periksa</label>
                <label><input type="checkbox" name="pelkes_sarana" value="lemari_obat"> Lemari Obat</label>
                <label><input type="checkbox" name="pelkes_sarana" value="wc"> Kamar Mandi / WC</label>
                <label><input type="checkbox" name="pelkes_sarana" value="alat_ukur"> Timbangan / Pengukur
                  Tinggi</label>
                <label><input type="checkbox" name="pelkes_sarana" value="register"> Register Pasien</label>
              ...
              <div>
                <label><input type="checkbox" name="pelkes_penunjang" value="apd"> Alat Pelindung Diri (APD)</label>
                <label><input type="checkbox" name="pelkes_penunjang" value="spirometer"> Spirometer</label>
                <label><input type="checkbox" name="pelkes_penunjang" value="audiometer"> Audiometer</label>
                <label><input type="checkbox" name="pelkes_penunjang" value="gas_detector"> Gas Detector</label>
              </div>

              <label for="pelkes_jumlah_kecelakaan">Jumlah Kecelakaan Kerja tercatat selama periode pelaporan</label>
              <input id="pelkes_jumlah_kecelakaan" type="number" min="0" value="0" placeholder="0"
                title="Jumlah kecelakaan">

              <label>Telah selesai melakukan pengisian</label>
              <div>
                <label><input type="checkbox" id="pelkes_selesai" title="Cek jika telah selesai"> Ya</label>
              </div>

              <label for="pelkes_file_report">Unggah Dokumen Pelaporan Pelayanan Kesehatan Kerja <span
                  class="small">*</span></label>
              <input id="pelkes_file_report" type="file" accept="application/pdf" title="Upload PDF, maks 10 MB"
                required>
              <div class="file-hint">Upload 1 file PDF. Maks 10 MB.</div>
        ...
        <div id="form_pelkes_full" class="card formdata hidden">
          ...
          <form id="form" enctype="multipart/form-data" novalidate>
            ...
            <label>Pengajuan Pengesahan Pelayanan Kesehatan Kerja di Perusahaan <span class="small">*</span></label>
            ...
            <div id="data-umum" class="fieldset hidden">
              ...
              <input id="nama-perusahaan" type="text" placeholder="PT ANGIN SEPOI SEJUK" pattern="[A-Z0-9 \-()&,]+"
                required>
              ...
              <label>Nama Dokter Penanggungjawab Pelayanan Kesehatan Kerja <span class="small">*</span></label>
            ...
            <div id="uploads" class="fieldset hidden">
              ...
              <label>Surat Pernyataan Penunjukan Dokter Penanggungjawab <span class="small">*</span></label>
              ...
              <label>Daftar Sarana Penyelenggaraan Pelayanan Kesehatan Kerja <span class="small">*</span></label>
              ...
              <div class="small">Catatan: WLKP dapat dilaporkan di <a href="https://wajiblapor.kemnaker.go.id/"
                  target="_blank" rel="noopener">wajiblapor.kemnaker.go.id</a> atau hubungi 081255774488 (Rahmat Avandi
                Katili)</div>
            </div>
              ...
              <form id="unduh_formUnduh" novalidate>
                ...
                <div class="unduh-row">
                  <div>
                    ...
                    <input id="unduh_email" name="unduh_email" type="email" placeholder="email@contoh.com" required />
                  </div>

                  <div>
                    <label for="unduh_nama">Nama Penerima Dokumen <span class="unduh-required">*</span></label>
                    <input id="unduh_nama" name="unduh_nama" type="text" placeholder="Nama lengkap" required />
                  </div>

                  <div>
                    <label for="unduh_jabatan">Jabatan <span class="unduh-required">*</span></label>
                    <input id="unduh_jabatan" name="unduh_jabatan" type="text" placeholder="Contoh: HR Manager"
                      required />
                  </div>

                  <div>
                    <label for="unduh_namaPerusahaan">Nama Perusahaan <span class="unduh-required">*</span></label>
                    <input id="unduh_namaPerusahaan" name="unduh_namaPerusahaan" type="text"
                      placeholder="Nama perusahaan" required />
                  </div>

                  <div class="unduh-full">
                    <label for="unduh_alamat">Alamat Perusahaan <span class="unduh-required">*</span></label>
                    <textarea id="unduh_alamat" name="unduh_alamat" placeholder="Alamat lengkap" required></textarea>
                  </div>

                  <div>
                    <label for="unduh_sektor">Sektor Perusahaan <span class="unduh-required">*</span></label>
                  ...
                  <div>
                    <label for="unduh_tanggalUnduh">Tanggal Unduh Dokumen <span class="unduh-required">*</span></label>
                  ...
                  <div class="unduh-full">
                    ...
                    <div class="doc-links-container">
                      <label><input type="radio" name="unduh_dokumen" value="sk_p2k3" required /> SK P2K3</label>
                      <label><input type="radio" name="unduh_dokumen" value="sk_pelayanan_kesehatan" /> SK Pengesahan
              ...
              <div id="unduh_successBox" class="unduh-success" role="status" aria-live="polite">
                ...
                <div class="unduh-links">
                  <div class="unduh-doc-link" id="unduh_linkSkP2k3">
                    <div>SK P2K3</div>
                    <div class="account-info">
                      <a href="https://shorturl.at/fFM7o" target="_blank" rel="noopener">Buka / Unduh</a>
                  ...
                  <div class="unduh-doc-link" id="unduh_linkSkPelayanan">
                    ...
                    <div class="account-info">
                      <a href="https://shorturl.at/DSuYx" target="_blank" rel="noopener">Buka / Unduh</a>
                      <button type="button" class="unduh-btn secondary"
                ...
                <div class="unduh-note">Catatan: Link tersedia sesuai pilihan dokumen yang Anda pilih pada form. Jika
