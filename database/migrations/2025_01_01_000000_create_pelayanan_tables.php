...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        // Pelayanan Kesekerja
        if (!Schema::hasTable('pelayanan_kesekerja')) {
        ...
        // Riwayat Pelayanan
        if (!Schema::hasTable('riwayat_pelayanan')) {
        ...
        // Unduh Dokumen K3
        if (!Schema::hasTable('unduh_dokumen_k3')) {
        ...
        // Pelaporan P2K3
        if (!Schema::hasTable('pelaporan_p2k3')) {
        ...
        // Pelaporan KK PAK
        if (!Schema::hasTable('pelaporan_kk_pak')) {
